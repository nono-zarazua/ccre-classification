...
if (( task_id <= 6 )); then
    ...
    train_dir="data/processed/evn/GRCh38/learning_curves"
    train_pos="${train_dir}/train_${percentage}_pos.fa"
    train_neg="${train_dir}/train_${percentage}_neg.fa"
    model_dir="models/evn/GRCh38/ls-gkm/learning_curves/${percentage}"
    ...
    train_dir="data/processed/evn/GRCh38/training/outer${outer}"
    train_pos="${train_dir}/train_pos.fa"
    train_neg="${train_dir}/train_neg.fa"
    model_dir="models/evn/GRCh38/ls-gkm/outer${outer}"
